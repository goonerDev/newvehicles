...
<img src="http://www.newvehicleparts.co.uk/assets/nvp/images/GlobalSign-Trust-Seal.png" style="width:90px"  class="pull-right"/>
<h1 class="fs-22 border-2-1010-1e2a51 padding-25002500">

	<span class="color-171f6a">Checkout</span>
</h1>
<p style="margin-bottom:10px;margin-left:5px;"><span class="hidden-xs"><small>You are now in our Secure one page Checkout, </span><b>All orders placed before 5pm we aim to deliver next working day to UK Mainland addresses,</b><span class="hidden-xs"> For Scottish Highlands, Isle of Wight, Isle of Man, Channel Islands, Northern & Southern Ireland and Isles of Scilly a fixed shipping charge of £30.00 applies.<br /></span>
<br /><strong>Unfortunatly any orders placed to countries other than United Kingdom,<span class="hidden-xs"> Isle of Man,</span> Channel  Islands, Ireland <span class="hidden-xs">&amp; Isle of Scilly</span> can not be processed, if in doubt call +44 (0) 1405 810 876</small></strong><br>

<a href="javascript:history.go(-1)" class="btn btn-primary pull-right">Continue Shopping</a>
</p>
...
<form name="checkout_form" method="post" action="<?php echo BASE_URL; ?>checkout" target="checkout_target"  class="clearfix">
	...
	<div class="col-xs-12 clearfix">
		...
		<input type="hidden" id="payment_method_sp" name="payment_method" value="Sagepay" <?php echo empty( $cart_details[ 'payment_method' ] ) || @$cart_details[ 'payment_method' ] == 'Sagepay' ? ' CHECKED' : ''; ?> data-tab-index="9"/> <!--<label for="payment_method_sp" checked>Credit card / Debit card (SagePay)</label>-->
		<br/>
		<!--<input type="radio" id="payment_method_pp" name="payment_method" value="Paypal" <?php echo @$cart_details[ 'payment_method' ] == 'Paypal' ? ' CHECKED' : ''; ?> data-tab-index="10"/> <label for="payment_method_pp">Paypal</label>-->
	...
	<div class="pull-left hidden-xs">
		<a id="checkout-continue-shopping-btn" href="javascript:history.go(-1)" class="btn btn-primary hidden-xs">Continue shopping</a>
	</div>
